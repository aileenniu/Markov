...
public class BaseMarkov implements MarkovInterface {
	...
	@Override
	 public String getRandomText(int length) {
        ...
        ArrayList<String> randomWords = new ArrayList<>(length); //o(1)
		int index = myRandom.nextInt(myWords.length - myOrder + 1); //o(1)
		WordGram current = new WordGram(myWords,index,myOrder); //o(1)
		randomWords.add(current.toString()); //o(1)
